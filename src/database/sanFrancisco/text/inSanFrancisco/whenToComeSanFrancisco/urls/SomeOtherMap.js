...
// URL of this page
const url = "/san-francisco/some-other-map666";

// Body title
const title = "SomeOther Map";
...
const someOtherMap = [SomeOtherMap, url, title, back, titleTag, descriptionTag];

export default someOtherMap;
